 ...
 */
export class RenameGolinkRequest extends Message<RenameGolinkRequest> {
  /**
  ...
  constructor(data?: PartialMessage<RenameGolinkRequest>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "golink.v1.RenameGolinkRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "old_name", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "new_name", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): RenameGolinkRequest {
    return new RenameGolinkRequest().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): RenameGolinkRequest {
    return new RenameGolinkRequest().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): RenameGolinkRequest {
    return new RenameGolinkRequest().fromJsonString(jsonString, options);
  }

  static equals(a: RenameGolinkRequest | PlainMessage<RenameGolinkRequest> | undefined, b: RenameGolinkRequest | PlainMessage<RenameGolinkRequest> | undefined): boolean {
    return proto3.util.equals(RenameGolinkRequest, a, b);
  }
}
 ...
 */
export class RenameGolinkResponse extends Message<RenameGolinkResponse> {
  /**
   * @generated from field: golink.v1.Golink golink = 1;
   */
  golink?: Golink;

  constructor(data?: PartialMessage<RenameGolinkResponse>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "golink.v1.RenameGolinkResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "golink", kind: "message", T: Golink },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): RenameGolinkResponse {
    return new RenameGolinkResponse().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): RenameGolinkResponse {
    return new RenameGolinkResponse().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): RenameGolinkResponse {
    return new RenameGolinkResponse().fromJsonString(jsonString, options);
  }

  static equals(a: RenameGolinkResponse | PlainMessage<RenameGolinkResponse> | undefined, b: RenameGolinkResponse | PlainMessage<RenameGolinkResponse> | undefined): boolean {
    return proto3.util.equals(RenameGolinkResponse, a, b);
  }
}
